...
public class TestLogicRepository {
    TestLogic testLogic;
    HashMap<ArrayList<String>, HashMap<String, List<HashMap<String,String>>>> map=new HashMap<>();
    public HashMap<ArrayList<String>, HashMap<String, List<HashMap<String,String>>>> loadTestLogic(TestData testData) {
